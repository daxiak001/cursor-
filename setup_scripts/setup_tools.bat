@echo off
chcp 65001 >nul 2>&1
title Setup Tools (winget + PowerShell 7)

echo =====================================================
echo    Setup Tools - winget and PowerShell 7
echo =====================================================
echo.

:: Use absolute English paths to avoid any encoding issues
...
:: Change to setup directory to avoid Chinese path issues
cd /d "%SETUP_DIR%"
...
if exist "%ProgramFiles%\PowerShell\7\pwsh.exe" (
    echo [OK] PowerShell 7: Available
    echo.
    echo Usage commands:
    ...
    echo [ERROR] PowerShell 7: Not available
)
